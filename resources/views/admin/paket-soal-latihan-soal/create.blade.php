@extends('layouts.app')
@section('title', 'Tambah Paket Soal Latihan Soal')
@section('page-title')
    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
        <h1 class="page-heading d-flex text-dark fw-bold flex-column justify-content-center my-0">
            Tambah Paket Soal Latihan Soal
        </h1>
    </div>
@endsection
@push('styles')
...
@section('content')
    <div class="card card-docs flex-row-fluid mb-2">
        <div class="card-body fs-6 text-gray-700">
            <form action="{{ route('admin.paket-soal-latihan-soal.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    <a href="{{ route('admin.paket-soal-latihan-soal') }}" type="reset"
