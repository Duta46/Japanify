...
<head>
    ...
    <title>Detail Menu {{ $menuTest->name }} | Japanify</title>
    <link rel="stylesheet"
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title text-center">
                        <h3 class="title">Detail Menu {{ $menuTest->name }}</h3>
                    </div>
                </div>
            </div>
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-7 col-sm-9">
                        <div class="features-style-one text-center">
                            ...
                            <div class="features-content">
                                <h4 class="features-title">Latihan Soal</h4>
                            {{-- <p class="text">
                                Short description for the ones who look for something new.
                                Awesome!
                            </p> --}}
                                <div class="features-btn rounded-buttons">
                                    <a class="btn primary-btn-outline rounded-full" href="{{ route('user.latihan-soal', ['menu_id' => $menuTest->id]) }}">
                                        Continue
                                    </a>
                                </div>
                            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-7 col-sm-9">
                        <div class="features-style-one text-center">
                            ...
                            <div class="features-content">
                                <h4 class="features-title">Ujian</h4>
                            {{-- <p class="text">
                                Short description for the ones who look for something new.
                                Awesome!
                            </p> --}}
